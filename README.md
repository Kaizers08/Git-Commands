...
• git status 
— Your repo’s daily health check
--------------------------------------
• git add .
— “Take everything, I’m ready”
--------------------------------------
• git commit -m "msg" 
— The diary entry for your work
--------------------------------------
• git push
...
--------------------------------------
• git blame {file}
— Name and shame (lovingly)
--------------------------------------
• git bisect 
— Find that one evil commit
--------------------------------------
• git fsck 
— Check repo sanity
...
--------------------------------------
• git checkout -- {file} 
— Bring back a lost file
--------------------------------------
• git stash 
— Hide your unfinished sins
--------------------------------------
• git reflog 
...
--------------------------------------
• git remote -v 
— Show your repo connections
--------------------------------------
• git pull origin main 
— Sync with the team
--------------------------------------
• git push -u origin branch-name 
— Set an upstream buddy
--------------------------------------
...
--------------------------------------
• git describe --tags 
— Find where you are in release land
--------------------------------------
...
--------------------------------------
• git prune 
— Get rid of unreachable commits
--------------------------------------
• git clean -fd 
— Delete untracked files (danger + power)
--------------------------------------
